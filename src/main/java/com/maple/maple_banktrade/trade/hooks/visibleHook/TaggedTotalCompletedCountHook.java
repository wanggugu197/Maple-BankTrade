...
public final class TaggedTotalCompletedCountHook extends MachineTradeHooks.VisibilityHook {
     ...
     * 便捷构造（flip = false）
     */
    public TaggedTotalCompletedCountHook(Identifier nameIndex, int threshold) {
