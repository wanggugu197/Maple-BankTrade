...
import com.maple.maple_banktrade.bank.cards.SingleCurrencyBankCard;

/**
 * 单货币银行卡的简略 / 详情 UI。
 */
public final class SingleCurrencyBankCardInfo {

    /** 创建简略卡 UI（含余额）。 */
    public static UIElement createSimplifiedUI(SingleCurrencyBankCard card) {
    ...
    /** 创建详情卡 UI（含余额）。 */
    public static UIElement createDetailsUI(Player player, SingleCurrencyBankCard card) {
    ...
    private SingleCurrencyBankCardInfo() {}
}
