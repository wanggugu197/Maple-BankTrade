...
public class TradeTypeRegistration {
    ...
    public static final CurrencyItemTradeType STONE_AND_ORES = CurrencyItemTradeType.of(MapleBankTrade.id("trade_type/stone_and_ores"));
    public static final CurrencyItemTradeStorage StoneAndOres = STONE_AND_ORES.register();
    public static final CurrencyItemTradeType PLANTS_AND_FOOD = CurrencyItemTradeType.of(MapleBankTrade.id("trade_type/plants_and_food"));
    public static final CurrencyItemTradeStorage PlantsAndFood = PLANTS_AND_FOOD.register();
    public static final CurrencyItemTradeType MOB_DROPS = CurrencyItemTradeType.of(MapleBankTrade.id("trade_type/mob_drops"));
    ...
    /** 电冶：矿石 / 原料 + 能量 → 锭。 */
    public static final MachineTradeType MACHINE_BENCH = MachineTradeType.of(MapleBankTrade.id("trade_type/machine_bench"));
    public static final MachineTradeStorage MachineBench = MACHINE_BENCH.register();
    /** 水洗：物品 + 流体 → 产物。 */
    public static final MachineTradeType MACHINE_WASHER = MachineTradeType.of(MapleBankTrade.id("trade_type/machine_washer"));
    public static final MachineTradeStorage MachineWasher = MACHINE_WASHER.register();
    /** 锻压成型：压缩 / 精炼 / 成型。 */
    public static final MachineTradeType MACHINE_FORGE = MachineTradeType.of(MapleBankTrade.id("trade_type/machine_forge"));
    public static final MachineTradeStorage MachineForge = MACHINE_FORGE.register();
    /** 银行台：铸币 / 采购等货币交易。 */
    public static final MachineTradeType MACHINE_BANK = MachineTradeType.of(MapleBankTrade.id("trade_type/machine_bank"));
    public static final MachineTradeStorage MachineBank = MACHINE_BANK.register();
    /** 能量台：流体 / 燃料 → 能量。 */
    public static final MachineTradeType MACHINE_POWER = MachineTradeType.of(MapleBankTrade.id("trade_type/machine_power"));
     ...
     */
    public static final MachineTradeType MACHINE_ITEM_DESK = MachineTradeType.of(MapleBankTrade.id("trade_type/machine_item_desk"));
     ...
     */
    public static final MachineTradeType AUTO_SELL_ORES_LAVA = MachineTradeType.of(MapleBankTrade.id("trade_type/auto_sell_ores_lava"), true);
    public static final MachineTradeStorage AutoSellOresLava = AUTO_SELL_ORES_LAVA.register();
    /**
     * 自动出售：怪物掉落物 → 硬币。
     * 允许 {@code autoTrade} 单输入条目。
     */
    public static final MachineTradeType AUTO_SELL_MOB_DROPS = MachineTradeType.of(MapleBankTrade.id("trade_type/auto_sell_mob_drops"), true);
